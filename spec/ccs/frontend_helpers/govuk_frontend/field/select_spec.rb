...
require 'ccs/frontend_helpers/govuk_frontend/field/select'

RSpec.describe CCS::FrontendHelpers::GovUKFrontend::Field::Select, type: :helper do
        ...
        it 'correctly formats the HTML with the hint' do
          expect(form_group_element.to_html).to eq('
            <div class="govuk-form-group" id="ouroboros-form-group">
              ...
              <select name="ouroboros" id="ouroboros" aria-describedby="ouroboros-hint" class="govuk-select">
                <option value="noah">Noah</option>
                <option value="mio">Mio</option>
                <option value="eunie">Eunie</option>
                <option value="taion">Taion</option>
      ...
      it 'correctly formats the HTML with error message and classes' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <select name="ouroboros" id="ouroboros" aria-describedby="ouroboros-error" class="govuk-select govuk-select--error">
              <option value="noah">Noah</option>
              <option value="mio">Mio</option>
              <option value="eunie">Eunie</option>
              <option value="taion">Taion</option>
      ...
      it 'correctly formats the HTML with error message and the hint with the aria-describedby from the hint then error message' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <select name="ouroboros" id="ouroboros" aria-describedby="ouroboros-hint ouroboros-error" class="govuk-select govuk-select--error">
              <option value="noah">Noah</option>
              <option value="mio">Mio</option>
              <option value="eunie">Eunie</option>
              <option value="taion">Taion</option>
        ...
        it 'correctly formats the HTML with the hint' do
          expect(form_group_element.to_html).to eq('
            <div class="govuk-form-group" id="ouroboros-form-group">
              ...
              <select aria-describedby="ouroboros-hint" class="govuk-select" name="test_model[ouroboros]" id="test_model_ouroboros">
                <option value="noah">Noah</option>
                <option value="mio">Mio</option>
                <option value="eunie">Eunie</option>
                <option value="taion">Taion</option>
      ...
      it 'correctly formats the HTML with error message and classes' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <select aria-describedby="ouroboros-error" class="govuk-select govuk-select--error" name="test_model[ouroboros]" id="test_model_ouroboros">
              <option value="noah">Noah</option>
              <option value="mio">Mio</option>
              <option value="eunie">Eunie</option>
              <option value="taion">Taion</option>
      ...
      it 'correctly formats the HTML with error message and the hint with the aria-describedby from the hint then error message' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <select aria-describedby="ouroboros-hint ouroboros-error" class="govuk-select govuk-select--error" name="test_model[ouroboros]" id="test_model_ouroboros">
              <option value="noah">Noah</option>
              <option value="mio">Mio</option>
              <option value="eunie">Eunie</option>
              <option value="taion">Taion</option>
