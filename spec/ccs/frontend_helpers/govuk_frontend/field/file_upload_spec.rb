...
require 'ccs/frontend_helpers/govuk_frontend/field/file_upload'

RSpec.describe CCS::FrontendHelpers::GovUKFrontend::Field::FileUpload, type: :helper do
  ...
  describe '.govuk_file_upload' do
    ...
    context 'when some options are not passed' do
      let(:result) { govuk_file_upload(attribute, **options) }
        ...
        it 'correctly formats the HTML with the hint' do
          expect(form_group_element.to_html).to eq('
            <div class="govuk-form-group" id="ouroboros-form-group">
              ...
              <input type="file" name="ouroboros" id="ouroboros" aria-describedby="ouroboros-hint" class="govuk-file-upload">
            </div>
          '.to_one_line)
        end
      end
      ...
      it 'correctly formats the HTML with error message and classes' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <input type="file" name="ouroboros" id="ouroboros" aria-describedby="ouroboros-error" class="govuk-file-upload govuk-file-upload--error">
          </div>
        '.to_one_line)
      end
      ...
      it 'correctly formats the HTML with error message and the hint with the aria-describedby from the hint then error message' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <input type="file" name="ouroboros" id="ouroboros" aria-describedby="ouroboros-hint ouroboros-error" class="govuk-file-upload govuk-file-upload--error">
          </div>
        '.to_one_line)
      end
        ...
        it 'correctly formats the HTML with the hint' do
          expect(form_group_element.to_html).to eq('
            <div class="govuk-form-group" id="ouroboros-form-group">
              ...
              <input aria-describedby="ouroboros-hint" class="govuk-file-upload" type="file" name="test_model[ouroboros]" id="test_model_ouroboros">
            </div>
          '.to_one_line)
        end
      end
      ...
      it 'correctly formats the HTML with error message and classes' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <input aria-describedby="ouroboros-error" class="govuk-file-upload govuk-file-upload--error" type="file" name="test_model[ouroboros]" id="test_model_ouroboros">
          </div>
        '.to_one_line)
      end
      ...
      it 'correctly formats the HTML with error message and the hint with the aria-describedby from the hint then error message' do
        expect(form_group_element.to_html).to eq('
          <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
            ...
            <input aria-describedby="ouroboros-hint ouroboros-error" class="govuk-file-upload govuk-file-upload--error" type="file" name="test_model[ouroboros]" id="test_model_ouroboros">
          </div>
        '.to_one_line)
      end
