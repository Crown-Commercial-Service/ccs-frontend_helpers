...
require 'ccs/frontend_helpers/govuk_frontend/field/character_count'

RSpec.describe CCS::FrontendHelpers::GovUKFrontend::Field::CharacterCount, type: :helper do
  ...
  let(:options) do
    {
      ...
      character_count: character_count_options
    }
  end
  ...
  describe '.govuk_character_count' do
    let(:result) { govuk_character_count(attribute, error_message: error_message, **options) }
    ...
    context 'when some options are not passed' do
      let(:result) { govuk_character_count(attribute, **options) }
          ...
          expect(character_count_element.to_html).to eq('
            <div class="govuk-character-count" data-module="govuk-character-count" data-maxlength="200">
              <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
                ...
                <textarea name="ouroboros" id="ouroboros" aria-describedby="ouroboros-info ouroboros-error" class="govuk-textarea govuk-textarea--error govuk-js-character-count" rows="5">
                </textarea>
              </div>
              <div id="ouroboros-info" class="govuk-hint govuk-character-count__message">
                You can enter up to 200 characters
          ...
          expect(character_count_element.to_html).to eq('
            <div class="govuk-character-count" data-module="govuk-character-count" data-maxlength="200">
              <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
                ...
                <textarea name="ouroboros" id="ouroboros" aria-describedby="ouroboros-info ouroboros-hint ouroboros-error" class="govuk-textarea govuk-textarea--error govuk-js-character-count" rows="5">
                </textarea>
              </div>
              <div id="ouroboros-info" class="govuk-hint govuk-character-count__message">
                You can enter up to 200 characters
  ...
  describe '.govuk_character_count with model' do
    let(:result) { govuk_character_count(attribute, model: model, **options) }
  ...
  describe '.govuk_character_count with form' do
    let(:result) { govuk_character_count(attribute, form: form, **options) }
    let(:form) do
          ...
          expect(character_count_element.to_html).to eq('
            <div class="govuk-character-count" data-module="govuk-character-count" data-maxlength="200">
              <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
                ...
                <textarea aria-describedby="test_model_ouroboros-info ouroboros-error" class="govuk-textarea govuk-textarea--error govuk-js-character-count" rows="5" name="test_model[ouroboros]" id="test_model_ouroboros">
                </textarea>
              </div>
              <div id="test_model_ouroboros-info" class="govuk-hint govuk-character-count__message">
                You can enter up to 200 characters
          ...
          expect(character_count_element.to_html).to eq('
            <div class="govuk-character-count" data-module="govuk-character-count" data-maxlength="200">
              <div class="govuk-form-group govuk-form-group--error" id="ouroboros-form-group">
                ...
                <textarea aria-describedby="test_model_ouroboros-info ouroboros-hint ouroboros-error" class="govuk-textarea govuk-textarea--error govuk-js-character-count" rows="5" name="test_model[ouroboros]" id="test_model_ouroboros">
                </textarea>
              </div>
              <div id="test_model_ouroboros-info" class="govuk-hint govuk-character-count__message">
                You can enter up to 200 characters
