...
RSpec.describe CCS::FrontendHelpers::GovUKFrontend::ServiceNavigation, '#validate_fixtures', type: :helper do
  component_name = 'service-navigation'
  fixture_list = {
    'default' => true,
    ...
    'inverse' => true,
    'with collapseNavigationOnMobile set to false' => true,
    'with a single navigation item' => true,
    'with a single navigation item and collapseNavigationOnMobile set to true' => true,
