...
RSpec.describe CCS::FrontendHelpers::GovUKFrontend::ErrorMessage, '#helpers', type: :helper do
  ...
  describe '.govuk_error_message' do
    ...
    context 'when the no attributes is sent' do
      let(:result) { govuk_error_message(message) }
