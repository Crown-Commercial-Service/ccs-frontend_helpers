    ...
    context 'when considering navigation' do
      ...
      context 'and no width is provided' do
        it 'has the default full width class' do
          expect(footer_navigation_element).to have_css('div.ccs-footer__section.govuk-grid-column-full')
        end
      end
      ...
      context 'and a columns is provided' do
        ...
        it 'has the columns class with the right number' do
          expect(footer_navigation_element).to have_css('ul.ccs-footer__list.ccs-footer__list--columns-2')
        end
      end
      ...
      context 'when additional classes are passed' do
        ...
        it 'does not have the custom class' do
          expect(footer_navigation_item_element[:class]).to eq 'ccs-footer__link'
        end
      end
    ...
    context 'when considering meta' do
      ...
      context 'and text is provided' do
        ...
        it 'has the additional meta text' do
          expect(footer_meta_element).to have_css('div.ccs-footer__meta-custom', text: 'Here is some custom meta text')
        end
      end
      ...
      context 'when additional classes are passed' do
        ...
        it 'does not have the custom class' do
          expect(footer_meta_item_element[:class]).to eq 'ccs-footer__link'
        end
      end
