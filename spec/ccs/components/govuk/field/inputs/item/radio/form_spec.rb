    ...
    context 'when there is conditional content within the item' do
      ...
      it 'correctly formats the HTML with the conditional item' do
        expect(radio_item_conditional_element.to_html).to eq('
          <body>
            <div class="govuk-radios__item">
              <input class="govuk-radios__input" data-aria-controls="conditional-ouroboros_eunie" type="radio" value="eunie" name="test_model[ouroboros]" id="test_model_ouroboros_eunie">
              <label class="govuk-label govuk-radios__label" for="test_model_ouroboros_eunie">
                Eunie
              </label>
            </div>
