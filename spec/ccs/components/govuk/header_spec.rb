...
require 'ccs/components/govuk/header'

RSpec.describe CCS::Components::GovUK::Header do
  ...
  describe '.render' do
    let(:govuk_header) { described_class.new(context: view_context, **header_options) }
          ...
          <div class="govuk-header__container govuk-width-container">
            <div class="govuk-header__logo">
              <a class="govuk-header__link govuk-header__link--homepage" href="https://www.crowncommercial.gov.uk/">
                <svg aria-label="GOV.UK" class="govuk-header__logotype" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 296 60" height="30" width="148" fill="currentcolor">
                  <title>GOV.UK</title>
                  <g>
    ...
    context 'when no service, naviagtion or container options are sent' do
      let(:govuk_header) { described_class.new(context: view_context) }
    ...
    context 'when rebrand is true' do
      let(:options) { super().merge({ rebrand: true }) }

      it 'renders the rebranded logo' do
        expect(header_element.to_html).to eq('
          <header class="govuk-header" data-module="govuk-header">
            <div class="govuk-header__container govuk-width-container">
              <div class="govuk-header__logo">
                <a class="govuk-header__link govuk-header__link--homepage" href="https://www.crowncommercial.gov.uk/">
                  <svg aria-label="GOV.UK" class="govuk-header__logotype" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 324 60" height="30" width="162" fill="currentcolor"><title>GOV.UK</title>
                    <g>
                      <circle cx="20" cy="17.6" r="3.7"></circle>
                      <circle cx="10.2" cy="23.5" r="3.7"></circle>
                      <circle cx="3.7" cy="33.2" r="3.7"></circle>
